...
{
    public partial class rpvDSSanPham : Form
    {
        public rpvDSSanPham()
        {
            InitializeComponent();
        ...
        private void rpvDSSanPham_Load(object sender, EventArgs e)
        {
            ...
            crystalRpvDSSanPham.ReportSource = rptDoc;
            crystalRpvDSSanPham.DisplayToolbar = true;
        }
