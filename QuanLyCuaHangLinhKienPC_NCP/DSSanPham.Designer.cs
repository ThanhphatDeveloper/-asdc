...
namespace QuanLyCuaHangLinhKienPC_NCP {
    ...
    public partial class DSSanPham : global::System.Data.DataSet {
        ...
        public partial class SanPhamDataTable : global::System.Data.TypedTableBase<SanPhamRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public SanPhamRow AddSanPhamRow(string MaSP, string TenSP, string MaLoai, string XuatXu, bool TrangThai) {
...
namespace QuanLyCuaHangLinhKienPC_NCP.DSSanPhamTableAdapters {
    ...
    public partial class SanPhamTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[SanPham] WHERE (([MaSP] = @Original_MaSP) AND ([TenSP] = @Orig" +
                "inal_TenSP) AND ([MaLoai] = @Original_MaLoai) AND ([XuatXu] = @Original_XuatXu) " +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[SanPham] ([MaSP], [TenSP], [MaLoai], [XuatXu], [TrangThai]) VA" +
                "LUES (@MaSP, @TenSP, @MaLoai, @XuatXu, @TrangThai);\r\nSELECT MaSP, TenSP, MaLoai," +
                " XuatXu, TrangThai FROM SanPham WHERE (MaSP = @MaSP)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[SanPham] SET [MaSP] = @MaSP, [TenSP] = @TenSP, [MaLoai] = @MaLoai, [XuatXu] = @XuatXu, [TrangThai] = @TrangThai WHERE (([MaSP] = @Original_MaSP) AND ([TenSP] = @Original_TenSP) AND ([MaLoai] = @Original_MaLoai) AND ([XuatXu] = @Original_XuatXu) AND ([TrangThai] = @Original_TrangThai));
SELECT MaSP, TenSP, MaLoai, XuatXu, TrangThai FROM SanPham WHERE (MaSP = @MaSP)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT MaSP, TenSP, MaLoai, XuatXu, TrangThai FROM dbo.SanPham";
        ...
        public virtual int Delete(string Original_MaSP, string Original_TenSP, string Original_MaLoai, string Original_XuatXu, bool Original_TrangThai) {
        ...
        public virtual int Insert(string MaSP, string TenSP, string MaLoai, string XuatXu, bool TrangThai) {
            if ((MaSP == null)) {
        ...
        public virtual int Update(string MaSP, string TenSP, string MaLoai, string XuatXu, bool TrangThai, string Original_MaSP, string Original_TenSP, string Original_MaLoai, string Original_XuatXu, bool Original_TrangThai) {
            if ((MaSP == null)) {
                throw new global::System.ArgumentNullException("MaSP");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string TenSP, string MaLoai, string XuatXu, bool TrangThai, string Original_MaSP, string Original_TenSP, string Original_MaLoai, string Original_XuatXu, bool Original_TrangThai) {
            return this.Update(Original_MaSP, TenSP, MaLoai, XuatXu, TrangThai, Original_MaSP, Original_TenSP, Original_MaLoai, Original_XuatXu, Original_TrangThai);
        }
    }
